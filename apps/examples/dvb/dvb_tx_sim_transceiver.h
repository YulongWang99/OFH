...
class dvb_tx_sim_transceiver : public ether::gateway, public ether::receiver
{
public:
  /// Default destructor.
  virtual ~dvb_tx_sim_transceiver() = default;
};

/// Ethernet transceiver implementation based on DPDK library.
class dpdk_transceiver : public dvb_tx_sim_transceiver
{
...
class socket_transceiver : public dvb_tx_sim_transceiver
{
public:
